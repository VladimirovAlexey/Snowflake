...
The integer $f$ is defined as 
$$1\leftrightarrow d,\qquad 2\leftrightarrow u,\qquad 3\leftrightarrow s,\qquad 4\leftrightarrow c,\qquad 5\leftrightarrow b
,\qquad 100\leftrightarrow p,\qquad 101\leftrightarrow n$$
where for p(proton)
\begin{eqnarray}
\bar g_{2,p}(x,Q)=\frac{4}{9}\(\bar g_{2,u}(x,Q)+\bar g_{2,c}(x,Q)\)+\frac{1}{9}\(\bar g_{2,d}(x,Q)+\bar g_{2,s}(x,Q)+\bar g_{2,b}(x,Q)\)
\\
d_{2,p}(x,Q)=\frac{4}{9}\(d_{2,u}(x,Q)+d_{2,c}(x,Q)\)+\frac{1}{9}\(d_{2,d}(x,Q)+d_{2,s}(x,Q)+d_{2,b}(x,Q)\).
\end{eqnarray}
For n(neutron) the u and d quarks are exchaged, ie.
\begin{eqnarray}
\bar g_{2,n}(x,Q)=\frac{4}{9}\(\bar g_{2,d}(x,Q)+\bar g_{2,c}(x,Q)\)+\frac{1}{9}\(\bar g_{2,u}(x,Q)+\bar g_{2,s}(x,Q)+\bar g_{2,b}(x,Q)\)
\\
d_{2,n}(x,Q)=\frac{4}{9}\(d_{2,d}(x,Q)+d_{2,c}(x,Q)\)+\frac{1}{9}\(d_{2,u}(x,Q)+d_{2,s}(x,Q)+d_{2,b}(x,Q)\).
\end{eqnarray}
